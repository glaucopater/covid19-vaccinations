...
const Vaccination3dBar = ({ position, onClick, vaccinations, population }) => {
  ...
  if (population > 0 && population < 1000000) populationFactor = 0.05;
  else if (population >= 1000000 && population < 100000000) populationFactor = 0.1;
...
const Earth = ({ setSelectedCountry }) => {
  ...
  const handleOnClick = (e, name, _, vaccinations, population) => {
    ...
    console.table(
      ...
      'vaccinations ' + vaccinations.toLocaleString(),
